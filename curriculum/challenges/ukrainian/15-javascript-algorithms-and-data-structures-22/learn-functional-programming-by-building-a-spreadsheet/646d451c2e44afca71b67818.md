...
Використайте `const`, щоб оголосити змінну `apply`.
...
Функція `apply` повинна мати `fn` як перший параметр.
...
Функція `apply` повинна мати `args` як другий параметр.
...
Функція `apply` має бути порожньою.
