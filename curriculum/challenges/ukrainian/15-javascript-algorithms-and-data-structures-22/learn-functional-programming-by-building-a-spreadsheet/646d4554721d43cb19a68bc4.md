...
Функція `apply` має використати неявне повернення.
...
Функція `apply` має отримати доступ до об’єкта `spreadsheetFunctions`.
...
Функція `apply` має отримати доступ до властивості об’єкта `spreadsheetFunctions`, що відповідає значенню `fn`.
