...
In your `elemValue` function, you explicitly declared a function called `inner` and returned it. However, because you are using arrow syntax, you can implicitly return a function. Наприклад:
...
Функція `addCharacters` має використати неявне повернення.
